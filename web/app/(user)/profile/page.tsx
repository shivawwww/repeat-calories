...
import { IconChevronRight, IconLogout, IconMapPin } from '@/components/ui/icons'
  ...
  return (
    <div className="mx-auto max-w-xl pb-6">
      ...
      <Link
        ...
        className="mt-4 flex items-center justify-between rounded-3xl border border-cream-deep bg-cream-soft p-5 transition-colors hover:bg-cream-deep/30"
      >
      ...
      {profile.auth_provider === 'credentials' && (
        <div className="mt-4 rounded-3xl border border-cream-deep bg-cream-soft p-6">
          ...
          <form onSubmit={handlePasswordUpdate} className="mt-4 flex flex-col gap-4">
            ...
            />
            <Button type="submit" loading={updating} className="self-start">
              Update Password
            </Button>
          </form>
        </div>
